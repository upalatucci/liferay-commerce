...
public class AppBuilderModulePersistenceTest {
	...
	private void _assertOriginalValues(AppBuilderModule appBuilderModule) {
		Assert.assertEquals(
			Long.valueOf(appBuilderModule.getCompanyId()),
			ReflectionTestUtil.<Long>invoke(
				appBuilderModule, "getColumnOriginalValue",
				new Class<?>[] {String.class}, "companyId"));
		Assert.assertEquals(
			appBuilderModule.getName(),
