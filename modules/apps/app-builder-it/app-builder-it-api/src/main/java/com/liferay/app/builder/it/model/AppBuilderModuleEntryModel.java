...
/**
 * The base model interface for the AppBuilderModuleEntry service. Represents a row in the &quot;AppBuilderModuleEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.app.builder.it.model.impl.AppBuilderModuleEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.app.builder.it.model.impl.AppBuilderModuleEntryImpl</code>.
 * </p>
 *
 * @author Marco Leo
 ...
 */
@ProviderType
public interface AppBuilderModuleEntryModel
	extends BaseModel<AppBuilderModuleEntry>, ShardedModel, StagedGroupedModel,
			WorkflowedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a app builder module entry model instance should use the {@link AppBuilderModuleEntry} interface instead.
	 */
