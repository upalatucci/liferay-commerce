...
/**
 * Provides the local service interface for AppBuilderModule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see AppBuilderModuleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AppBuilderModuleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.app.builder.it.service.impl.AppBuilderModuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the app builder module local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AppBuilderModuleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AppBuilderModule createAppBuilderModule(long appBuilderModuleId);
	...
	public AppBuilderModule deleteAppBuilderModule(
		AppBuilderModule appBuilderModule);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AppBuilderModule deleteAppBuilderModule(long appBuilderModuleId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AppBuilderModule fetchAppBuilderModule(long appBuilderModuleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AppBuilderModule fetchAppBuilderModuleByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AppBuilderModule getAppBuilderModuleByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AppBuilderModule> getAppBuilderModules(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AppBuilderModule updateAppBuilderModule(
		AppBuilderModule appBuilderModule);
