...
/**
 * Provides the local service interface for AppBuilderModuleEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see AppBuilderModuleEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AppBuilderModuleEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.app.builder.it.service.impl.AppBuilderModuleEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the app builder module entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AppBuilderModuleEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
